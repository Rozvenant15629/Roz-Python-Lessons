...
base_convert = int(input("enter base to convert (2/8/10/16): "))
decimal_a = int(a, 0)
decimal_b = int(b, 0)
decimal_c = int(c, 0)
...
Average = (decimal_a + decimal_b + decimal_c) / 3
Quotient = (decimal_a + decimal_b) // decimal_c
Remainder = (decimal_a + decimal_b) % decimal_c
print("Sum:", Sum, "|",  "in base", base_convert, ":", convert_total(Sum, base_convert))
print("Difference:", Difference, "|", "in base", base_convert, ":", convert_total(Difference, base_convert))
print("Product:", Product, "|", "in base", base_convert, ":", convert_total(Product, base_convert))
print("Averange:", round(Average, 2))
print("Quotient:", Quotient, "|", "in base", base_convert, ":", convert_total(Quotient, base_convert))
